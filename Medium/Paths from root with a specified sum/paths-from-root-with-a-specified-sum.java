...
class Solution
{
   public static void helper(Node root, int sum, ArrayList<Integer> temp, ArrayList<ArrayList<Integer>> ans) {
    ...
    helper(root.left, rem, temp, ans);
    helper(root.right, rem, temp, ans);
